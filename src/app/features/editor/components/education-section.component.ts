...
import { Section, EducationItem } from "../../../core/models/resume.model";
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="text" formControlName="institution" class="input" />
            @if (submitted && itemForm.controls['institution'].errors) {
            <p class="mt-1 text-sm text-error-500">Institution is required</p>
            }
          </div>
          ...
          <div>
            ...
            <input type="text" formControlName="degree" class="input" />
            @if (submitted && itemForm.controls['degree'].errors) {
            <p class="mt-1 text-sm text-error-500">Degree is required</p>
            }
          </div>
        </div>
        ...
        <div class="mb-4">
          ...
          <input type="text" formControlName="field" class="input" />
        </div>
...
export class EducationSectionComponent {
  ...
  @Output() itemAdded = new EventEmitter<Partial<EducationItem>>();
  @Output() itemUpdated = new EventEmitter<{
    id: string;
    updates: Partial<EducationItem>;
  }>();
  ...
  editItem(item: EducationItem): void {
  ...
  submitItemForm(): void {
    ...
    if (this.itemForm.valid) {
      ...
      const itemData: Partial<EducationItem> = {
